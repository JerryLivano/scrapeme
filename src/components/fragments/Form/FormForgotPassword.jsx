...
const FormForgotPassword = () => {
    ...
    return (
        <>
            ...
            <p className="mt-10 text-sm text-center text-gray-500 float-end">
                <Link
                    to={'/login'}
                    className="font-semibold leading-6 text-indigo-600 hover:text-indigo-500 flex gap-x-2 items-center"
                >
