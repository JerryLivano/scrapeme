...
const DropdownPageInput = forwardRef(function DropdownPageInputInternal(
    {
        required = false,
        label,
        placeholder,
        ...
        <div className={twMerge("flex flex-col", className)}>
            <select
                className={twMerge(
                    ...
                    disabled && "cursor-not-allowed bg-gray-100 text-gray-4"
                )}
                ref={ref}
                {...props}
                required={required}
...
export default DropdownPageInput;
