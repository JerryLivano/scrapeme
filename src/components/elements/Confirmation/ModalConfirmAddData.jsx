...
export default function ModalConfirmAddData({
    title,
    message,
    openModal,
    setOpenModal,
                            ...
                            <Dialog.Panel className='relative overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg'>
                                <div className='bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4'>
                                    <div className='sm:flex sm:items-start'>
                                        <div className='mx-auto flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-[#E6DDFA] sm:mx-0 sm:h-10 sm:w-10'>
                                            <QuestionMarkCircleIcon
                                                className='h-7 w-7 text-[#5928ED]'
                                                aria-hidden='true'
                                            />
                                        </div>
                                ...
                                <div className='bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6'>
                                    <button
                                        ...
                                        className='inline-flex w-full justify-center rounded-md bg-[#5928ED] px-8 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 sm:ml-3 sm:w-auto'
                                    >
                                        Yes
                                    </button>
                                    <button
