...
export default function ModalConfirmAccept({
    title,
    message,
    openModalConfirmAccept,
    setOpenModalConfirmAccept,
    onAcceptHandler,
    isLoading,
}) {
    ...
    return (
        <>
            <Transition.Root show={openModalConfirmAccept} as={Fragment}>
                <Dialog
                    as='div'
                    className='relative z-50'
                    initialFocus={cancelButtonRef}
                    onClose={setOpenModalConfirmAccept}
                >
                    <Transition.Child
                        as={Fragment}
                                ...
                                <Dialog.Panel className='relative overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg'>
                                    ...
                                    <div className='bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6'>
                                        ...
                                        <button
                                            ...
                                            onClick={() =>
                                                setOpenModalConfirmAccept(false)
                                            }
                                            ref={cancelButtonRef}
                                        >
                                            Cancel
