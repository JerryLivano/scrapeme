...
export default function ModalConfirmDone({
    title,
    message,
    openModalConfirmDone,
    setOpenModalConfirmDone,
    onDoneHandler,
    isLoading,
}) {
    ...
    return (
        <>
            <Transition.Root show={openModalConfirmDone} as={Fragment}>
                <Dialog
                    as='div'
                    className='relative z-50'
                    initialFocus={cancelButtonRef}
                    onClose={setOpenModalConfirmDone}
                >
                    <Transition.Child
                        as={Fragment}
